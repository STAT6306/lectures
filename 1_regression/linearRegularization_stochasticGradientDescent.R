...
##############################
# Goal: Update the code to allow for stochastic gradient descent 
#       Change the iteration scheme to terminate after a condition is met
#          instead of after a number of iterations
##############################
